...
object Dependencies {
  ...
  lazy val avroSerdes: ModuleID   =
    ("io.confluent" % "kafka-streams-avro-serde" % "7.3.2").exclude("org.apache.kafka", "kafka-streams-scala")
  lazy val avroSerializers: ModuleID = "io.confluent" % "kafka-avro-serializer" % "7.3.2"
